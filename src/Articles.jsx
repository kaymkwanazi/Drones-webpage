    ...
    <div className='articles'>
        ...
        <div className="cards-section">
            <div className='my-card'>
                <img className="card-img" src ={Picture1} alt="drone1" width={"100%"} />
                <div className="rectangle-2"></div>
                <p>How  to automate <br></br> surveillance drones</p>
            </div>
            <div className='my-card'>
                <img className="card-img" src ={Picture2} alt="drone1" width={"100%"} />
                <div className="rectangle-2"></div>
                <p>Robotics and Artificial  <br></br> Intelligence</p>
            </div>
            <div className='my-card'>
                <img className="card-img" src ={Picture3} alt="drone1" width={"100%"} />
                <div className="rectangle-2"></div>
                <p>Improving Lives through  <br></br> Robotic Prosthetics</p>
            </div>
            <div className='my-card'>
                <img className="card-img" src ={Picture4} alt="drone1" width={"100%"} />
                <div className="rectangle-2"></div>
